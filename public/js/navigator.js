...
const PRESET_JOURNALS = [
  {
    ...
    pageCount: 1,
    preset: true,
    pages: [{ title: 'Try Adding an image of kidney in the box using the magic pen', text: '', canvas: 'public/images/presets/preset-1.png' }],
    settings: { color: 'blush', dark: false, size: 'a4', spacing: 'narrow', template: 'blank', margin: false, bgImage: 'public/images/templates/12.png' },
  },
  {
    id: 'preset-2',
    ...
    pageCount: 1,
    preset: true,
    pages: [{ title: 'Try asking Nova how you have improved compared to your previous week\'s journal', text: '', canvas: 'public/images/presets/preset-2.png' }],
    settings: { color: 'blush', dark: false, size: 'a4', spacing: 'narrow', template: 'blank', margin: false, bgImage: 'public/images/templates/8.png' },
  },
  {
    id: 'preset-3',
    ...
    pageCount: 1,
    preset: true,
    pages: [{ title: 'Ask Nova to explain this text to you', text: '', canvas: 'public/images/presets/preset-3.png' }],
    settings: { color: 'blush', dark: false, size: 'a4', spacing: 'narrow', template: 'blank', margin: false, bgImage: 'public/images/templates/7.jpeg' },
  },
  {
    id: 'preset-4',
    ...
    pageCount: 1,
    preset: true,
    pages: [{ title: 'Try encircling the unsolved equation using the magic pen and ask me to solve it', text: '', canvas: 'public/images/presets/preset-4.png' }],
    settings: { color: 'blush', dark: false, size: 'a4', spacing: 'narrow', template: 'blank', margin: false, bgImage: 'public/images/templates/before.png' },
  },
];
